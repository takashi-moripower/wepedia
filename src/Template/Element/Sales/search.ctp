...
$list_selectors = [
	...
	'result' => ['' => '結果'] + array_combine( \Cake\Core\Configure::read('sale.result') , \Cake\Core\Configure::read('sale.result') ),
];

$session_key = 'WEPEDIA_SEARCH_SALES';
?>
<?= $this->Form->create(NULL, ['class' => 'search-form search-form-sales form-inline text-right', 'session_key' => $session_key]) ?>
